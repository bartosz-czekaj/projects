...
import com.example.spring.boot.conf.demo.model.Survey;
...
public class SurveyService {
    ...
    public Question retrieveQuestion(String surveyId, String questionId) {
        ...
        return survey.getQuestions().stream().filter(question -> question.getId().equals(questionId)).findFirst().orElse(null);
