...
public class ClientHandler implements Runnable {
    ...
    private void sendResponse(Socket socket,int statusCode, String responseString) {
        try (DataOutputStream out = new DataOutputStream(socket.getOutputStream());) {
            prepareResponse(statusCode, out, responseString);
            out.close();
    ...
    private void prepareResponse(int statusCode, DataOutputStream out, String responseString) throws IOException {
        String statusLine;
