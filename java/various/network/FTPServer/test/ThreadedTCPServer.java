...
public class ThreadedTCPServer implements Runnable {
    ...
    public static void Establish() {
        ...
        try  {
            ...
            ServerSocket serverSocketChannel = new ServerSocket(controlPort);
            serverSocketChannel.setReuseAddress(true);
    ...
    public void run() {
        ...
        try {
            ...
            long dataPort = clientSocket.getPort();


            CommandHandler cs = new CommandHandler(printWriter, dataPort);
